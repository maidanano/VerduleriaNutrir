...
public class EmployeesController implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_employee) {
            ...
            if (row == -1) {
                ...
                if (question == 0 && employeeDao.deleteEmployeesQuery(id) != false) {
                    cleanTable();
                    cleanFields();
                    views.btn_register_employee.setEnabled(true);
            ...
            String confirm_password = String.valueOf(views.txt_pasword_modify_confirm.getPassword());

            //Verificar si las cajas de textos están vacías
            if (!password.equals("") && !confirm_password.equals("")) {
                ...
                if (password.equals(confirm_password)) {
                    ...
                    //Validar que toda salio bien
                    if (employeeDao.updateEmployeesPassword(employee) != false) {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        }else if(e.getSource() == views.btnEmployees){
            if (rol.equals("Administrador")){
                ...
                views.btnEmployees.setEnabled(false);
