...
public class CategoriesController implements ActionListener, MouseListener, KeyListener {
    ...
    public CategoriesController(Categories category, CategoriesDao categoryDao, SystemView views) {
        ...
        //Botón de moficar categoria
        this.views.btn_update_cartegory.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_category) {
        ...
        } else if (e.getSource() == views.btn_update_cartegory) {
            ...
            if (row == -1) {
                JOptionPane.showMessageDialog(null, "Debes elegir una categoría para eliminar");
            } else {
                int id = Integer.parseInt(views.categories_table.getValueAt(row, 0).toString());
                int question = JOptionPane.showConfirmDialog(null, "¿En realidad quieres eliminar a esta categoría?");
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        } else if (e.getSource() == views.btnCategories) {
            if (rol.equals("Administrador")) {
                ...
                views.btnCategories.setEnabled(false);
                JOptionPane.showMessageDialog(null, "No tienes privilegios de Admonistrador para acceder a esta vista");
