...
public class CustomersController implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_customer) {
            ...
            if (views.txt_customer_id.getText().equals("")
                ...
                if (customerDao.resgisterCustumerQuery(customer)) {
                    cleanTable();
                    ListAllCustomers();
            ...
            if (views.txt_customer_id.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Selecciona una fila para conntinuar");
            } else {
                if (views.txt_customer_id.getText().equals("")
                        || views.txt_customer_fullname.getText().equals("")
                        || views.txt_customer_address.getText().equals("")
                    ...
                    if (customerDao.updateCustumerQuery(customer)) {
                        cleanTable();
                        cleanFields();
                        ListAllCustomers();
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        } else if (e.getSource() == views.btnCustomers) {
